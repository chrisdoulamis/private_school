...
CREATE TABLE `trainers_per_course` (
  `id_t_p_c` int(11) NOT NULL AUTO_INCREMENT,
  `idcourse` int(11) NOT NULL,
  `idtrainer` int(11) NOT NULL,
  PRIMARY KEY (`id_t_p_c`),
  KEY `fkIdx_102` (`idtrainer`),
  KEY `fkIdx_96` (`idcourse`),
  CONSTRAINT `FK_102` FOREIGN KEY (`idtrainer`) REFERENCES `trainers` (`idtrainer`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_96` FOREIGN KEY (`idcourse`) REFERENCES `courses` (`idcourse`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `trainers_per_course` VALUES (1,1,1),(2,2,1),(3,3,2),(4,4,2),(6,6,1);

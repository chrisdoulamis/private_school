...
CREATE TABLE `submit` (
  ...
  `id_apspc` int(11) NOT NULL,
  PRIMARY KEY (`id_sub`),
  KEY `fkIdx_196` (`id_apspc`),
  CONSTRAINT `FK_196` FOREIGN KEY (`id_apspc`) REFERENCES `assignments_per_student_per_course` (`id_apspc`) ON DELETE CASCADE ON UPDATE CASCADE
